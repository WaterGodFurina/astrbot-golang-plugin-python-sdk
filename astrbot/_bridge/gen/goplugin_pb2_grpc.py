...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in goplugin_pb2_grpc.py depends on'
...
class GRPCBrokerStub:
    ...
    def __init__(self, channel):
        ...
        self.StartStream = channel.stream_stream(
                ...
                request_serializer=goplugin__pb2.ConnInfo.SerializeToString,
                response_deserializer=goplugin__pb2.ConnInfo.FromString,
...
def add_GRPCBrokerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StartStream': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=goplugin__pb2.ConnInfo.FromString,
                    response_serializer=goplugin__pb2.ConnInfo.SerializeToString,
            ),
    }
...
class GRPCBroker:
    ...
    def StartStream(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/plugin.GRPCBroker/StartStream',
            goplugin__pb2.ConnInfo.SerializeToString,
            goplugin__pb2.ConnInfo.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
